...
export default {
  data() {
	...
	yaocaizhonglei : false,
            ...
            ruleForm: {
                          ...
                          rules: {
                  yaocaizhonglei: [
                            { required: true, message: '药材种类不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yaocaizhonglei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaocaizhongleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
