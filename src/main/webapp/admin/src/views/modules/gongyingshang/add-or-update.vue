          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="银行卡号" prop="yinxingkahao">
          <el-input v-model="ruleForm.yinxingkahao" 
              placeholder="银行卡号" clearable  :readonly="ro.yinxingkahao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="银行卡号" prop="yinxingkahao">
              <el-input v-model="ruleForm.yinxingkahao" 
                placeholder="银行卡号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='yinxingkahao'){
            this.ruleForm.yinxingkahao = obj[o];
	    this.ro.yinxingkahao = true;
            continue;
          }
	                    }
                                                                                                              }
