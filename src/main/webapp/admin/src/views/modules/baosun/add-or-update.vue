          ...
          <el-form-item class="input" label="药材名称" prop="yaocaimingcheng">
              <el-input v-model="ruleForm.yaocaimingcheng" 
                placeholder="药材名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药材种类" prop="yaocaizhonglei">
          <el-input v-model="ruleForm.yaocaizhonglei" 
              placeholder="药材种类" clearable  :readonly="ro.yaocaizhonglei"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `baosun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baosunCrossAddOrUpdateFlag = false;
                  this.parent.search();
