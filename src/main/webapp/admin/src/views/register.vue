  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">中药分类管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="家庭住址" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.jiatingzhuzhi" autocomplete="off" placeholder="家庭住址" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.zhaopian" class="input" type="text" placeholder="照片">
			   </div>
			 </div> -->
			<el-form-item label="照片" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.zhaopian" autocomplete="off" placeholder="照片" type="text" />
			</el-form-item>
