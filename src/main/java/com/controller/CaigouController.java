...
public class CaigouController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,CaigouEntity caigou, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,CaigouEntity caigou, HttpServletRequest request){
        EntityWrapper<CaigouEntity> ew = new EntityWrapper<CaigouEntity>();
		PageUtils page = caigouService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, caigou), params), params));
        return R.ok().put("data", page);
    }
